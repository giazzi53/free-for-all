...
class Map():
    ...
    def __init__(self):
        ...
        self.backgrounds = [pygame.image.load('Scenarios/ringue.png').convert_alpha(), pygame.image.load('Scenarios/floresta.png').convert_alpha(),
							pygame.image.load('Scenarios/deserto.png').convert_alpha()]
