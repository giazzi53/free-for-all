...
class Map():
    ...
    def __init__(self):
        ...
        self.backgrounds = [pygame.image.load('Images/Scenarios/ringue.png').convert_alpha(), pygame.image.load('Images/Scenarios/floresta.png').convert_alpha(),
							pygame.image.load('Images/Scenarios/deserto.png').convert_alpha()]
